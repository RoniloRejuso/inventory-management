...
<hr class="m-0">
<a class="dropdown-item" href="logs.php.php"><button class="btn btn-primary btn-block" id="logoutButton">Logout</button>
...
<a class="dropdown-item" href="generalsetting.php">Settings</a>
