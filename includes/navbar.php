...
<form id="searchForm" action="search_results.php">
        <div class="searchinputs">
          <input type="text" name="query" placeholder=""> <!-- Added 'name="query"' -->
          <div class="search-addon">
            <span><img src="" alt="img"></span>
          </div>
        </div>
        <button type="submit" class="btn" id="searchdiv"><img src="" ></button>
      </form>
</div>
</li>
<script>
...
<hr class="m-0">
<a class="dropdown-item" href="profile.php"> <i class="me-2" data-feather="user"></i> </a>
<a class="dropdown-item" href="profile.php"><i class="me-2" data-feather="settings"></i></a>
<hr class="m-0">
...
<a class="dropdown-item" href="profile.php"></a>
<a class="dropdown-item" href="logs.php"></a>
</div>
</div>
