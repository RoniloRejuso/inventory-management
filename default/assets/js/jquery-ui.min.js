      ...
      for (
        t.drawMonth = J,
          ...
          i = K
            ? this.formatDate(
                i,
                this._daylightSavingAdjust(new Date(te, J - X, 1)),
        ...
        for (k = "", this.maxRows = 4, C = 0; V[1] > C; C++) {
              ...
              switch (C) {
                case 0:
                  (I += " ui-datepicker-group-first"),
                    (P = " ui-corner-" + (Y ? "right" : "left"));
                  break;
                case V[1] - 1:
                  (I += " ui-datepicker-group-last"),
                    (P = " ui-corner-" + (Y ? "left" : "right"));
                  break;
                default:
          ...
          for (
            I +=
              ...
              P +
              "'>" +
              (/all|left/.test(P) && 0 === x ? (Y ? o : s) : "") +
              (/all|right/.test(P) && 0 === x ? (Y ? s : o) : "") +
          ...
          for (
            I += T + "</tr></thead><tbody>",
              ...
              z = (this._getFirstDayOfMonth(te, J) - c + 7) % 7,
              H = Math.ceil((z + S) / 7),
              O = $ ? (this.maxRows > H ? this.maxRows : H) : H,
              this.maxRows = O,
